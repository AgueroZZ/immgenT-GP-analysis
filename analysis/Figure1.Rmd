...
(light green), GP7 (green), GP196 (yellow). A fully-labeled version with a
color→GP legend (all 200 GP indices) is kept for reference in
`experiments/gene_correlation_network/` (`heatmap_loading`).
:::
