...
```{r fig1c-code, code=readLines("../script/Figure1.R")[98:172], eval=FALSE}
```
...
```{r fig1d-code, code=readLines("../script/Figure1.R")[259:269], eval=FALSE}
```
...
```{r fig1e-code, code=readLines("../script/Figure1.R")[183:193], eval=FALSE}
```
...
```{r fig1f-code, code=readLines("../script/Figure1.R")[248:257], eval=FALSE}
```
...
```{r fig1g-code, code=readLines("../script/Figure1.R")[213:232], eval=FALSE}
```
...
```{r fig1h-code, code=readLines("../script/Figure1.R")[195:211], eval=FALSE}
```
...
```{r fig1i-code, code=readLines("../script/Figure1.R")[234:246], eval=FALSE}
```
