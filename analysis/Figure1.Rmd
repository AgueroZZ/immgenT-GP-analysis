...
```{r fig1d-code, code=readLines("../script/Figure1.R")[284:290], eval=FALSE}
```
...
```{r fig1e-code, code=readLines("../script/Figure1.R")[194:209], eval=FALSE}
```
...
```{r fig1f-code, code=readLines("../script/Figure1.R")[264:273], eval=FALSE}
```
...
```{r fig1g-code, code=readLines("../script/Figure1.R")[229:248], eval=FALSE}
```
...
```{r fig1h-code, code=readLines("../script/Figure1.R")[211:227], eval=FALSE}
```
...
```{r fig1i-code, code=readLines("../script/Figure1.R")[250:262], eval=FALSE}
```
