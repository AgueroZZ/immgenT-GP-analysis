...
```{r fig3-setup, code=readLines("../script/Figure3.R")[1:50], eval=FALSE}
```

## (3c) Activation effect, CD4 vs. CD8 {#fig3c}

```{r fig3c-code, code=readLines("../script/Figure3.R")[52:100], eval=FALSE}
```
...
```{r fig3d-code, code=readLines("../script/Figure3.R")[102:161], eval=FALSE}
```
...
```{r fig3e-code, code=readLines("../script/Figure3.R")[163:200], eval=FALSE}
```
...
```{r fig3f-code, code=readLines("../script/Figure3.R")[248:299], eval=FALSE}
```
...
```{r fig3g-code, code=readLines("../script/Figure3.R")[202:246], eval=FALSE}
```
