...
```{r fig3-setup, code=readLines("../script/Figure3.R")[1:45], eval=FALSE}
```

## (3c) Activation effect, CD4 vs. CD8 {#fig3c}

```{r fig3c-code, code=readLines("../script/Figure3.R")[47:95], eval=FALSE}
```
...
```{r fig3d-code, code=readLines("../script/Figure3.R")[97:156], eval=FALSE}
```
...
```{r fig3e-code, code=readLines("../script/Figure3.R")[158:195], eval=FALSE}
```
...
```{r fig3f-code, code=readLines("../script/Figure3.R")[243:294], eval=FALSE}
```
...
```{r fig3g-code, code=readLines("../script/Figure3.R")[197:241], eval=FALSE}
```
