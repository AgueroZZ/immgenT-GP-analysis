...
```{r fig4-setup, code=readLines("../script/Figure4.R")[1:91], eval=FALSE}
```

## (a) Max AUC: organ vs. lineage {#fig4a}

```{r fig4a-code, code=readLines("../script/Figure4.R")[92:180], eval=FALSE}
```
...
```{r fig4b-code, code=readLines("../script/Figure4.R")[247:341], eval=FALSE}
```
...
```{r fig4c-code, code=readLines("../script/Figure4.R")[390:492], eval=FALSE}
```
...
```{r fig4d-code, code=readLines("../script/Figure4.R")[181:246], eval=FALSE}
```
...
```{r fig4e-code, code=readLines("../script/Figure4.R")[342:389], eval=FALSE}
```
