...
[`script-refactor/Figure4.R`](https://github.com/stephenslab/immgen-t-factors/blob/main/script-refactor/Figure4.R).
...
```{r fig4-setup, code=readLines("../script-refactor/Figure4.R")[1:87], eval=FALSE}
```

## (a) Max AUC: organ vs. lineage {#fig4a}

```{r fig4a-code, code=readLines("../script-refactor/Figure4.R")[88:176], eval=FALSE}
```
...
```{r fig4b-code, code=readLines("../script-refactor/Figure4.R")[243:337], eval=FALSE}
```
...
```{r fig4c-code, code=readLines("../script-refactor/Figure4.R")[386:489], eval=FALSE}
```
...
```{r fig4d-code, code=readLines("../script-refactor/Figure4.R")[177:242], eval=FALSE}
```
...
```{r fig4e-code, code=readLines("../script-refactor/Figure4.R")[338:385], eval=FALSE}
```
