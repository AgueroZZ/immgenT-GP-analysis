...
```{r fig5-setup, code=readLines("../script/Figure5.R")[1:91], eval=FALSE}
```

## (a) Max AUC: organ vs. lineage {#fig5a}

```{r fig5a-code, code=readLines("../script/Figure5.R")[92:180], eval=FALSE}
```
...
```{r fig5b-code, code=readLines("../script/Figure5.R")[247:341], eval=FALSE}
```
...
```{r fig5c-code, code=readLines("../script/Figure5.R")[388:430], eval=FALSE}
```
...
```{r fig5d-code, code=readLines("../script/Figure5.R")[181:246], eval=FALSE}
```
...
```{r fig5e-code, code=readLines("../script/Figure5.R")[342:389], eval=FALSE}
```
