...
[`script-refactor/Figure6.R`](https://github.com/AgueroZZ/immgenT-GP-analysis/blob/main/script-refactor/Figure6.R),
which shares its CITE-seq setup with [Figure S6](FigureS6.html) via
`code-refactor/R/citeseq_shared_setup.R`. The code below is shown for
...
```{r fig6-setup, code=readLines("../script-refactor/Figure6.R")[23:33], eval=FALSE}
```

Panels (b) onward additionally load the shared CITE-seq cell/protein setup:

```{r fig6-setup2, code=readLines("../script-refactor/Figure6.R")[37:51], eval=FALSE}
```
...
```{r fig6b-code, code=readLines("../script-refactor/Figure6.R")[53:77], eval=FALSE}
```
...
```{r fig6cf-code, code=readLines("../script-refactor/Figure6.R")[79:104], eval=FALSE}
```
...
```{r fig6gh-code, code=readLines("../script-refactor/Figure6.R")[106:171], eval=FALSE}
```
...
```{r fig6ik-code, code=readLines("../script-refactor/Figure6.R")[173:261], eval=FALSE}
```
