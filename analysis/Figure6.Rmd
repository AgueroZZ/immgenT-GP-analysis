...
```{r fig6-setup, code=readLines("../script/Figure6.R")[39:49], eval=FALSE}
```

Panels (b) onward additionally load the shared CITE-seq cell/protein setup:

```{r fig6-setup2, code=readLines("../script/Figure6.R")[53:67], eval=FALSE}
```
...
```{r fig6b-code, code=readLines("../script/Figure6.R")[69:145], eval=FALSE}
```
...
```{r fig6cf-code, code=readLines("../script/Figure6.R")[147:172], eval=FALSE}
```
...
```{r fig6gh-code, code=readLines("../script/Figure6.R")[174:239], eval=FALSE}
```
...
```{r fig6ik-code, code=readLines("../script/Figure6.R")[241:329], eval=FALSE}
```
