...
```{r fig6-setup, code=readLines("../script/Figure6.R")[37:47], eval=FALSE}
```

Panels (b) onward additionally load the shared CITE-seq cell/protein setup:

```{r fig6-setup2, code=readLines("../script/Figure6.R")[51:65], eval=FALSE}
```
...
```{r fig6b-code, code=readLines("../script/Figure6.R")[67:91], eval=FALSE}
```
...
```{r fig6cf-code, code=readLines("../script/Figure6.R")[93:118], eval=FALSE}
```
...
```{r fig6gh-code, code=readLines("../script/Figure6.R")[120:185], eval=FALSE}
```
...
```{r fig6ik-code, code=readLines("../script/Figure6.R")[187:275], eval=FALSE}
```
