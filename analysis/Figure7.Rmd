...
This page documents **Figure 7b**. The other panels of Figure 7 (RQVI validates
EBMF-derived gene programs with a non-linear deep learning framework) are
produced by the RQVI framework and are documented in the companion repository for
RQVI.
