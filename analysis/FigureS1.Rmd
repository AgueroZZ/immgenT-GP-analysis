...
```{r figs1-setup, code=readLines("../script/FigureS1.R")[1:31], eval=FALSE}
```

Panels A and B both use the cached per-IGT cosine score matrix:

```{r figs1-setup-ab, code=readLines("../script/FigureS1.R")[33:37], eval=FALSE}
```

## (A) Cumulative GPs validated as IGTs are added {#figs1a}

```{r figs1a-code, code=readLines("../script/FigureS1.R")[60:85], eval=FALSE}
```
...
```{r figs1b-code, code=readLines("../script/FigureS1.R")[39:58], eval=FALSE}
```
...
```{r figs1c-setup, code=readLines("../script/FigureS1.R")[87:95], eval=FALSE}
```

```{r figs1c-code, code=readLines("../script/FigureS1.R")[97:121], eval=FALSE}
```
...
```{r figs1d-code, code=readLines("../script/FigureS1.R")[123:152], eval=FALSE}
```
