...
```{r figs2-setup, code=readLines("../script/FigureS2.R")[1:35], eval=FALSE}
```

## (A) GP30 loading across Tz subsets {#figs2a}

```{r figs2a-code, code=readLines("../script/FigureS2.R")[37:64], eval=FALSE}
```
...
```{r figs2b-code, code=readLines("../script/FigureS2.R")[66:94], eval=FALSE}
```
...
```{r figs2c-code, code=readLines("../script/FigureS2.R")[96:130], eval=FALSE}
```
