...
```{r figs3c-code, code=readLines("../script/FigureS3.R")[54:75], eval=FALSE}
```
...
```{r figs3d-code, code=readLines("../script/FigureS3.R")[77:96], eval=FALSE}
```
...
```{r figs3e-code, code=readLines("../script/FigureS3.R")[137:190], eval=FALSE}
```
...
```{r figs3f-code, code=readLines("../script/FigureS3.R")[275:398], eval=FALSE}
```
...
```{r figs3g-code, code=readLines("../script/FigureS3.R")[98:135], eval=FALSE}
```
...
```{r figs3h-code, code=readLines("../script/FigureS3.R")[192:273], eval=FALSE}
```
