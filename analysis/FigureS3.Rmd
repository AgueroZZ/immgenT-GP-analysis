---
title: "Extended Data Figure 3: Characterizing activation-associated GPs"
author: "Ziang Zhang"
...
**Lettering note.** The gate definition in (a) used to be split into two panels,
a (the MDEs) and b (the protein plot); they are one panel, so every panel after it
is now one letter lower than in the published figure -- (b) here is the published
(c), and (g) is the published (h).
...
::: {.figcaption}
**Extended Data Fig. 3a.** Definition of resting and activated CD4+ and CD8+ T cells.
...
## (g) TF-GP network for Gata3/Rorc/Tbx21 {#figs3g}
