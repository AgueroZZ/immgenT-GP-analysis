...
[`script-refactor/FigureS3.R`](https://github.com/stephenslab/immgen-t-factors/blob/main/script-refactor/FigureS3.R),
...
```{r figs3-setup, code=readLines("../script-refactor/FigureS3.R")[1:46], eval=FALSE}
```

## (s3c) GP26+ rate by organ {#figs3c}

```{r figs3c-code, code=readLines("../script-refactor/FigureS3.R")[48:69], eval=FALSE}
```
...
```{r figs3d-code, code=readLines("../script-refactor/FigureS3.R")[71:90], eval=FALSE}
```
...
```{r figs3e-code, code=readLines("../script-refactor/FigureS3.R")[131:184], eval=FALSE}
```
...
```{r figs3f-code, code=readLines("../script-refactor/FigureS3.R")[269:392], eval=FALSE}
```
...
```{r figs3g-code, code=readLines("../script-refactor/FigureS3.R")[92:129], eval=FALSE}
```
...
```{r figs3h-code, code=readLines("../script-refactor/FigureS3.R")[186:267], eval=FALSE}
```
