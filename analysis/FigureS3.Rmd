...
```{r figs3-setup, code=readLines("../script/FigureS3.R")[1:52], eval=FALSE}
```

## (s3c) GP26+ rate by organ {#figs3c}

```{r figs3c-code, code=readLines("../script/FigureS3.R")[54:89], eval=FALSE}
```
...
```{r figs3d-code, code=readLines("../script/FigureS3.R")[91:110], eval=FALSE}
```
...
```{r figs3e-code, code=readLines("../script/FigureS3.R")[151:204], eval=FALSE}
```
...
```{r figs3f-code, code=readLines("../script/FigureS3.R")[289:412], eval=FALSE}
```
...
```{r figs3g-code, code=readLines("../script/FigureS3.R")[112:149], eval=FALSE}
```
...
```{r figs3h-code, code=readLines("../script/FigureS3.R")[206:287], eval=FALSE}
```
