---
title: "Figure S5: Protein programs across GPs"
author: "Ziang Zhang"
...
Published as **Extended Data Figure 5**.
...
[Figure 6](Figure6.html) and [Figure S6](FigureS6.html) via
...
**This figure was split out of Figure S6 on 2026-07-30.** It was that figure's
panel s6a, and before 2026-07-28 the published Figure 6b. It now stands alone in
the Extended Data Figure 5 slot that main [Figure 7b](Figure7.html) vacated, and
[Figure S6](FigureS6.html)'s remaining panels each dropped one letter (its
s6b-s6g are now s6a-s6f).
...
::: {.figcaption}
**Fig. S5.** Heatmap of scaled protein scores for each GP (the re-estimated
