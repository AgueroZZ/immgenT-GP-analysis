---
title: "Figure S5: EBMF versus matched-RQVI factor comparison across level-2 clusters"
author: "Ziang Zhang"
...
r >= 0.5. The left and right panels and the shared colorbar are saved as
`S5a.pdf`, `S5b.pdf`, and `S5_shared_relative_loading_colorbar.pdf` in
`figures/final-selected/Figure S5/`.
:::
...
`script/FigureS5.R` builds the raw `annotation_level2` cluster-mean matrix for the
