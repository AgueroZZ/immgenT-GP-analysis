...
#       shifted-log expression, top genes labeled. NOT from script/ or
#       code/ -- generated by the separate "immgen-signature" Shiny app
#       (.../Immgen/webapps/immgen-signature/); see
#       code-refactor/R/volcano_helpers.R for the ported plotting function
...
# The original script/Figure_Overview.R produces 3 more outputs (raw
...
#
# Source: ported from script/Figure_Overview.R (panels C, E-I) and
# script/Figure_Lineage.R's "MDE by Lineage" section (panel A, confirmed by
...
data_path <- "data/"
figure_path <- "figure-refactor/Figure 1/"
source("code-refactor/R/volcano_helpers.R") # plot_gp_signature_volcano() for panel 1D
...
# ============================================================
# 1D: GP1 signature volcano (see code-refactor/R/volcano_helpers.R header
# for why this isn't from script/Figure_Overview.R)
# ============================================================
