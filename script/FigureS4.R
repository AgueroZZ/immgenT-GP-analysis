# Figure S4. Protein programs across GPs.
#
# One panel (see analysis/FigureS4.Rmd for the caption text):
#   s4   Heatmap of the re-estimated protein matrix U (sparse: |score| < 0.5
...
#
# Split out of what is now Figure S5 on 2026-07-30. It was that figure's panel
...
# took slot 5, and back to Extended Data Figure 5 on 2026-09-10, when Extended
# Data Figure 3 was folded into Extended Data Figure 2 as its panel d and
# everything after it moved up one. For anyone diffing against
# figures/Previous/bits/:
#
#   now   was                    what
#   s4    Figure 6/6b            protein-program heatmap
#
...
# gating inputs Figure 7 / Figure S5 use); it is sourced as-is rather than
...
# ============================================================
expected_panels <- paste0(figure_path, "s4", ".pdf")
