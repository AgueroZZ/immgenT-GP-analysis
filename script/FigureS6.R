...
# figure's first panel became a standalone figure (now script/FigureS5.R);
# renumbered from Figure S6 to Figure S7 on 2026-08-27, when the per-lineage
# structure plots took the Extended Data Figure 5 slot; and back to Figure S6
# on 2026-09-10, when Extended Data Figure 3 was folded into Extended Data
# Figure 2 as its panel d and everything after it moved up one. Only letters
# and paths moved; no panel was re-rendered. For anyone diffing against
