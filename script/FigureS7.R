# Figure S7. CD69-associated GPs and further surface-protein gating strategies.
#
# Panels produced (see analysis/FigureS7.Rmd for the caption text):
#   s7a,s7b  Mean loading of the 10 curated CD69-associated GPs
...
#   s7c-s7f  Protein-gate vs. GP-loading comparison on the MDE embedding, for
...
# figure's first panel became a standalone figure (now script/FigureS6.R), and
# renumbered from Figure S6 to Figure S7 on 2026-08-27, when the per-lineage
# structure plots took the Extended Data Figure 5 slot. Only letters and paths
# moved; no panel was re-rendered. For anyone diffing against
# figures/Previous/bits/ -- note its `Figure S6/` and `Figure S7/` are the OLD
# numbering and are NOT this figure:
#
#   now   was                    what
#   --    Figure 6/6b            protein-program heatmap -> Figure S6 (script/FigureS6.R)
#   s7a   Figure 6/6j            CD69 GPs, mean activity per tissue
#   s7b   Figure 6/6k            CD69 GPs, mean activity per lineage
#   s7c   inside Figure S6/s6-1  gating, GP29
#   s7d   inside Figure S6/s6-1  gating, GP58
#   s7e   inside Figure S6/s6-1  gating, GP22
#   s7f   inside Figure S6/s6-2  gating, GP68
...
# ============================================================
expected_panels <- paste0(figure_path, c("s7a", "s7b", figs7_gating), ".pdf")
