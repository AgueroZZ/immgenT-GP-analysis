# Figure S8. CD69-associated GPs and further surface-protein gating strategies.
#
# Panels produced (see analysis/FigureS8.Rmd for the caption text):
#   s8a,s8b  Mean loading of the 10 curated CD69-associated GPs
...
#   s8c-s8f  Protein-gate vs. GP-loading comparison on the MDE embedding, for
...
# figure's first panel became a standalone figure (now script/FigureS7.R);
# renumbered from Figure S6 to Figure S7 on 2026-08-27, when the per-lineage
# structure plots took the Extended Data Figure 5 slot; and to Figure S8 on
# 2026-09-09, when a new cluster-level figure was inserted at Extended Data 3
# and a new tissue figure at 5. Only letters and paths moved; no panel was
# re-rendered. For anyone diffing against figures/Previous/bits/ -- note its
# `Figure S6/` and `Figure S7/` are the OLD numbering and are NOT this figure:
#
#   now   was                    what
#   --    Figure 6/6b            protein-program heatmap -> Figure S7 (script/FigureS7.R)
#   s8a   Figure 6/6j            CD69 GPs, mean activity per tissue
#   s8b   Figure 6/6k            CD69 GPs, mean activity per lineage
#   s8c   inside Figure S6/s6-1  gating, GP29
#   s8d   inside Figure S6/s6-1  gating, GP58
#   s8e   inside Figure S6/s6-1  gating, GP22
#   s8f   inside Figure S6/s6-2  gating, GP68
...
# ============================================================
expected_panels <- paste0(figure_path, c("s8a", "s8b", figs8_gating), ".pdf")
