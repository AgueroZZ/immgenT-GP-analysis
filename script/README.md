...
that Figure 7b had vacated. The remaining panels each dropped one letter (the two
...
replacement for main Figure 5. Extended Data 5-8 are unaffected and keep the
numbers they had before this pass.
...
Data figures renumbered on 2026-08-27 and again on 2026-09-09. A same-letter filename comparison is
...
**S4**; our S3 is the cluster heatmap and has no published counterpart.
