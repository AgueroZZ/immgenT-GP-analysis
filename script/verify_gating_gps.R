...
#
# Figure 7e-7j and Figure S6c-S6f are ten protein-gate vs. GP-loading panels,
...
cat("\n=== 2. Figure 7 and Figure S6 show disjoint GPs ===\n")
both <- intersect(names(fig7), names(figs6))
